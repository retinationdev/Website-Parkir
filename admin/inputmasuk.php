...
<form action="formValue.php" method="post" onsubmit="return validate()"> 
                    <input type="hidden" name="role" value="2">
                    <input class="text" type="text" name="email" id="email" placeholder="Nomor ID" required="required">
                </br>
                    ...
                    <input type="submit" name="register" id="register" value="Masuk">
                </form>
